...
ALL_TOOL_NAMES = frozenset(
    {
        ...
        "run_generated_analog_project",
        "plan_natural_analog_frontend",
        "run_natural_analog_frontend",
        "plan_natural_dc_network",
        "plan_natural_common_emitter",
        "run_natural_common_emitter",
        "run_natural_dc_network",
        "submit_natural_engineering_job",
        "plan_natural_opamp_engineering_request",
        "run_natural_engineering_request",
        "plan_model_engineering_request",
        "run_model_engineering_request",
        "submit_model_engineering_request",
        "review_design_requirements",
        "bind_requirement_review_to_design",
        "snapshot_open_circuit",
        "run_native_parameter_sweep",
        "rank_native_sweep_results",
        "prepare_native_sweep_patch",
        "apply_native_sweep_patch_to_copy",
